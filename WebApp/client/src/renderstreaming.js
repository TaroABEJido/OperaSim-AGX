...
export class RenderStreaming {
   ...
   */
  async createConnection(connectionId, rtpStreamId) {
    this._connectionId = connectionId ? connectionId : uuid4();
    this._rtpStreamId = rtpStreamId;
    await this._signaling.createConnection(this._connectionId, this._rtpStreamId);
  }
